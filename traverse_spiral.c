...
void get_dimensions(FILE *fp, int *size) {        
	...
	// Assigns pointer to size of square matrix
	char *token = NULL; 
 ...
 * size: variable storing the size of the arrayt
...
int main(int argc, char *argv[]) {                  
	...
	Square *squareptr; //Pointer to a square

	squareptr = malloc(sizeof(Square)); //Allocate size for square
	
	squareptr->array = board; // Initialize array field 
	squareptr->size = size; // Initialize size field
	...
	traverse_spirally(squareptr, op);
